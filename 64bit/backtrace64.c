/*
   ...
   how to use: Call LoadLibraryA("backtrace64.dll"); at beginning of your program .


*/

#define PACKAGE "your-program-name" /* for libbfd */
	...
	while(StackWalk(IMAGE_FILE_MACHINE_AMD64,   /* walk the stack for the x86_64 architecture */
		...
		*/
		HINSTANCE module_base = (HINSTANCE) SymGetModuleBase(process, frame.AddrPC.Offset);
                ...
                if (module_base && GetModuleFileNameA(module_base, module_name_raw, MAX_PATH)) {
